...
/**
 * TaskOptimTimeWindowTest Class Doc Comment
 *
 * @category    Class
 * @description Time window for executing a task in the optimization module (appointment). End time is not required.
 * @package     ProgressionLive
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TaskOptimTimeWindowTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Test "TaskOptimTimeWindow"
     */
    public function testTaskOptimTimeWindow()
    {
    }
