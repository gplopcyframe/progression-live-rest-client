...
------------ | ------------- | ------------- | -------------
**module** | [**\ProgressionLive\Model\EntityRef**](EntityRef.md) |  | 
**enabled** | **bool** | Option to know if the module configuration is enabled. Some configurations cannot be disabled. | [optional] 
