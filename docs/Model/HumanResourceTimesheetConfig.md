...
------------ | ------------- | ------------- | -------------
**activities** | [**\ProgressionLive\Model\EntityRef[]**](EntityRef.md) | List of activities available for this hr. | [optional] 
**timeKioskPin** | **string** | Identification number for this hr. | [optional] 
