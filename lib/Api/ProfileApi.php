...
class ProfileApi
{
    ...
    /**
     * Operation profileUpdatePost
     *
     * @param  \ProgressionLive\Model\Profile $body Profile (required)
     *
     * @throws \ProgressionLive\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function profileUpdatePost($body)
    {
        $this->profileUpdatePostWithHttpInfo($body);
    }

    /**
     * Operation profileUpdatePostWithHttpInfo
     *
     * @param  \ProgressionLive\Model\Profile $body Profile (required)
     *
     * @throws \ProgressionLive\ApiException on non-2xx response
     ...
     */
    public function profileUpdatePostWithHttpInfo($body)
    {
        $returnType = '';
        $request = $this->profileUpdatePostRequest($body);
    ...
    /**
     * Operation profileUpdatePostAsync
     *
     * 
     *
     * @param  \ProgressionLive\Model\Profile $body Profile (required)
     ...
     */
    public function profileUpdatePostAsync($body)
    {
        return $this->profileUpdatePostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation profileUpdatePostAsyncWithHttpInfo
     *
     * 
     *
     * @param  \ProgressionLive\Model\Profile $body Profile (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function profileUpdatePostAsyncWithHttpInfo($body)
    {
        $returnType = '';
        $request = $this->profileUpdatePostRequest($body);
    ...
    /**
     * Create request for operation 'profileUpdatePost'
     *
     * @param  \ProgressionLive\Model\Profile $body Profile (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function profileUpdatePostRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling profileUpdatePost'
            );
        }

        $resourcePath = '/profile/update';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
