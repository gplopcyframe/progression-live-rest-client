...
class TestApi
{
     ...
     * Operation echoPost
     *
     * @param  \ProgressionLive\Model\EchoMessage $body EchoMessage (required)
     *
     * @throws \ProgressionLive\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ProgressionLive\Model\EchoMessage
     */
    public function echoPost($body)
    {
        list($response) = $this->echoPostWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation echoPostWithHttpInfo
     *
     * @param  \ProgressionLive\Model\EchoMessage $body EchoMessage (required)
     *
     * @throws \ProgressionLive\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ProgressionLive\Model\EchoMessage, HTTP status code, HTTP response headers (array of strings)
     */
    public function echoPostWithHttpInfo($body)
    {
        $returnType = '\ProgressionLive\Model\EchoMessage';
        $request = $this->echoPostRequest($body);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ProgressionLive\Model\EchoMessage',
     ...
     */
    public function echoPostAsync($body)
    {
        return $this->echoPostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation echoPostAsyncWithHttpInfo
     *
     * 
     *
     * @param  \ProgressionLive\Model\EchoMessage $body EchoMessage (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function echoPostAsyncWithHttpInfo($body)
    {
        $returnType = '\ProgressionLive\Model\EchoMessage';
        $request = $this->echoPostRequest($body);
    ...
    /**
     * Create request for operation 'echoPost'
     *
     * @param  \ProgressionLive\Model\EchoMessage $body EchoMessage (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function echoPostRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling echoPost'
            );
        }
