...
/**
 * LocalizableOptionsListApi Class Doc Comment
 *
 * @category Class
 * @package  ProgressionLive
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LocalizableOptionsListApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation localizablelistIdentifierGet
     *
     * Get a localizable options list.
     *
     * @param  string $identifier Localizable options list&#x27;s identifier (id). (required)
     *
     * @throws \ProgressionLive\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ProgressionLive\Model\LocalizableOptionsList
     */
    public function localizablelistIdentifierGet($identifier)
    {
        list($response) = $this->localizablelistIdentifierGetWithHttpInfo($identifier);
        return $response;
    }

    /**
     * Operation localizablelistIdentifierGetWithHttpInfo
     *
     * Get a localizable options list.
     *
     * @param  string $identifier Localizable options list&#x27;s identifier (id). (required)
     ...
     * @throws \ProgressionLive\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ProgressionLive\Model\LocalizableOptionsList, HTTP status code, HTTP response headers (array of strings)
     */
    public function localizablelistIdentifierGetWithHttpInfo($identifier)
    {
        $returnType = '\ProgressionLive\Model\LocalizableOptionsList';
        $request = $this->localizablelistIdentifierGetRequest($identifier);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ProgressionLive\Model\LocalizableOptionsList',
    ...
    /**
     * Operation localizablelistIdentifierGetAsync
     *
     * Get a localizable options list.
     *
     * @param  string $identifier Localizable options list&#x27;s identifier (id). (required)
     ...
     */
    public function localizablelistIdentifierGetAsync($identifier)
    {
        return $this->localizablelistIdentifierGetAsyncWithHttpInfo($identifier)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation localizablelistIdentifierGetAsyncWithHttpInfo
     *
     * Get a localizable options list.
     *
     * @param  string $identifier Localizable options list&#x27;s identifier (id). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function localizablelistIdentifierGetAsyncWithHttpInfo($identifier)
    {
        $returnType = '\ProgressionLive\Model\LocalizableOptionsList';
        $request = $this->localizablelistIdentifierGetRequest($identifier);
    ...
    /**
     * Create request for operation 'localizablelistIdentifierGet'
     *
     * @param  string $identifier Localizable options list&#x27;s identifier (id). (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function localizablelistIdentifierGetRequest($identifier)
    {
        // verify the required parameter 'identifier' is set
        if ($identifier === null || (is_array($identifier) && count($identifier) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifier when calling localizablelistIdentifierGet'
            );
        }

        $resourcePath = '/localizablelist/{identifier}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation localizablelistListGet
     *
     * Search for localizable options lists.
     *
     * @param  string $label Filter by localizable options list label. This parameter does a LIKE search. (optional)
     *
     * @throws \ProgressionLive\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ProgressionLive\Model\LocalizableOptionsList[]
     */
    public function localizablelistListGet($label = null)
    {
        list($response) = $this->localizablelistListGetWithHttpInfo($label);
        return $response;
    }

    /**
     * Operation localizablelistListGetWithHttpInfo
     *
     * Search for localizable options lists.
     *
     * @param  string $label Filter by localizable options list label. This parameter does a LIKE search. (optional)
     ...
     * @return array of \ProgressionLive\Model\LocalizableOptionsList[], HTTP status code, HTTP response headers (array of strings)
     */
    public function localizablelistListGetWithHttpInfo($label = null)
    {
        $returnType = '\ProgressionLive\Model\LocalizableOptionsList[]';
        $request = $this->localizablelistListGetRequest($label);
    ...
    /**
     * Operation localizablelistListGetAsync
     *
     * Search for localizable options lists.
     *
     * @param  string $label Filter by localizable options list label. This parameter does a LIKE search. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function localizablelistListGetAsync($label = null)
    {
        return $this->localizablelistListGetAsyncWithHttpInfo($label)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation localizablelistListGetAsyncWithHttpInfo
     *
     * Search for localizable options lists.
     *
     * @param  string $label Filter by localizable options list label. This parameter does a LIKE search. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function localizablelistListGetAsyncWithHttpInfo($label = null)
    {
        $returnType = '\ProgressionLive\Model\LocalizableOptionsList[]';
        $request = $this->localizablelistListGetRequest($label);
    ...
    /**
     * Create request for operation 'localizablelistListGet'
     *
     * @param  string $label Filter by localizable options list label. This parameter does a LIKE search. (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function localizablelistListGetRequest($label = null)
    {

        $resourcePath = '/localizablelist/list';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
