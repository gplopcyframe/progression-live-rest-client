...
/**
 * TaxConfigApi Class Doc Comment
 *
 * @category Class
 * @package  ProgressionLive
 * @author   Swagger Codegen team
...
class TaxConfigApi
{
    ...
    /**
     * Operation taxConfigIdentifierGet
     *
     ...
     */
    public function taxConfigIdentifierGet($identifier)
    {
        list($response) = $this->taxConfigIdentifierGetWithHttpInfo($identifier);
        return $response;
    }

    /**
     * Operation taxConfigIdentifierGetWithHttpInfo
     *
     * Get a tax configuration.
     *
     * @param  string $identifier Contact&#x27;s identifier. One of id, uid, externalId or label (unique). (required)
     ...
     * @throws \ProgressionLive\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ProgressionLive\Model\TaxConfig, HTTP status code, HTTP response headers (array of strings)
     */
    public function taxConfigIdentifierGetWithHttpInfo($identifier)
    {
        $returnType = '\ProgressionLive\Model\TaxConfig';
        $request = $this->taxConfigIdentifierGetRequest($identifier);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ProgressionLive\Model\TaxConfig',
    ...
    /**
     * Operation taxConfigIdentifierGetAsync
     *
     * Get a tax configuration.
     *
     * @param  string $identifier Contact&#x27;s identifier. One of id, uid, externalId or label (unique). (required)
     ...
     */
    public function taxConfigIdentifierGetAsync($identifier)
    {
        return $this->taxConfigIdentifierGetAsyncWithHttpInfo($identifier)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation taxConfigIdentifierGetAsyncWithHttpInfo
     *
     * Get a tax configuration.
     *
     * @param  string $identifier Contact&#x27;s identifier. One of id, uid, externalId or label (unique). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function taxConfigIdentifierGetAsyncWithHttpInfo($identifier)
    {
        $returnType = '\ProgressionLive\Model\TaxConfig';
        $request = $this->taxConfigIdentifierGetRequest($identifier);
    ...
    /**
     * Create request for operation 'taxConfigIdentifierGet'
     *
     * @param  string $identifier Contact&#x27;s identifier. One of id, uid, externalId or label (unique). (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function taxConfigIdentifierGetRequest($identifier)
    {
        // verify the required parameter 'identifier' is set
        if ($identifier === null || (is_array($identifier) && count($identifier) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifier when calling taxConfigIdentifierGet'
            );
        }

        $resourcePath = '/taxConfig/{identifier}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $label Filter by tax configuration label. This parameter does a LIKE search. (optional)
     ...
     * @return \ProgressionLive\Model\TaxConfig[]
     */
    public function taxConfigListGet($maxResults = null, $startResult = null, $label = null, $externalId = null, $updated = null)
    {
        list($response) = $this->taxConfigListGetWithHttpInfo($maxResults, $startResult, $label, $externalId, $updated);
        return $response;
    }

    /**
     * Operation taxConfigListGetWithHttpInfo
     *
     * Search for tax configurations.
     *
     * @param  int $maxResults Maximum number of results to return. The default maximum number is 500 and cannot be exceeded. (optional)
     ...
     * @return array of \ProgressionLive\Model\TaxConfig[], HTTP status code, HTTP response headers (array of strings)
     */
    public function taxConfigListGetWithHttpInfo($maxResults = null, $startResult = null, $label = null, $externalId = null, $updated = null)
    {
        $returnType = '\ProgressionLive\Model\TaxConfig[]';
        $request = $this->taxConfigListGetRequest($maxResults, $startResult, $label, $externalId, $updated);
    ...
    /**
     * Operation taxConfigListGetAsync
     *
     * Search for tax configurations.
     *
     * @param  int $maxResults Maximum number of results to return. The default maximum number is 500 and cannot be exceeded. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function taxConfigListGetAsync($maxResults = null, $startResult = null, $label = null, $externalId = null, $updated = null)
    {
        return $this->taxConfigListGetAsyncWithHttpInfo($maxResults, $startResult, $label, $externalId, $updated)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation taxConfigListGetAsyncWithHttpInfo
     *
     * Search for tax configurations.
     *
     * @param  int $maxResults Maximum number of results to return. The default maximum number is 500 and cannot be exceeded. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function taxConfigListGetAsyncWithHttpInfo($maxResults = null, $startResult = null, $label = null, $externalId = null, $updated = null)
    {
        $returnType = '\ProgressionLive\Model\TaxConfig[]';
        $request = $this->taxConfigListGetRequest($maxResults, $startResult, $label, $externalId, $updated);
    ...
    /**
     * Create request for operation 'taxConfigListGet'
     *
     * @param  int $maxResults Maximum number of results to return. The default maximum number is 500 and cannot be exceeded. (optional)
     * @param  int $startResult Buffer data range to ignore before fetching the data. In combination with the maxResults, implements a pagination logic.  Example : 1000 results to fetch StartResult &#x3D; 0, MaxResult &#x3D; 500 (results &#x3D; 1 à 500) StartResult &#x3D; 500, MaxResult &#x3D; 500 (results &#x3D; 501 à 1000) (optional)
     * @param  string $label Filter by tax configuration label. This parameter does a LIKE search. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function taxConfigListGetRequest($maxResults = null, $startResult = null, $label = null, $externalId = null, $updated = null)
    {

        $resourcePath = '/taxConfig/list';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
