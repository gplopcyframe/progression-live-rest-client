...
/**
 * TaskItemList Class Doc Comment
 *
 * @category Class
 * @package  ProgressionLive
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TaskItemList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TaskItemList';
    ...
    protected static $swaggerTypes = [
        'subTotal' => 'float',
'total' => 'float',
'items' => '\ProgressionLive\Model\TaskItem[]',
'url' => 'string',
'id' => 'float',
'uid' => 'string',
'created' => '\DateTime',
...
'tags' => 'getTags'    ];
     ...
     * Sets subTotal
     *
     * @param float $subTotal Task' subtotal (readonly)
     *
     * @return $this
     */
     ...
     * Sets total
     *
     * @param float $total Task' total (readonly)
     *
     * @return $this
     */
     ...
     * Gets items
     *
     * @return \ProgressionLive\Model\TaskItem[]
     */
     ...
     * Sets items
     *
     * @param \ProgressionLive\Model\TaskItem[] $items items
     *
     * @return $this
     */
