...
'enabled' => 'bool',
'expand' => 'string',
'filters' => '\ProgressionLive\Model\WebhookFilter[]',
'url' => 'string',
'id' => 'float',
'created' => '\DateTime',
'updated' => '\DateTime',
...
self::EVENT_TYPE_DELETE,        ];
     ...
     * Sets expand
     *
     * @param string $expand List of fields to expand when the URL is called. Comma sperated list.
     *
     * @return $this
     */
     ...
     * Gets filters
     *
     * @return \ProgressionLive\Model\WebhookFilter[]
     */
     ...
     * Sets filters
     *
     * @param \ProgressionLive\Model\WebhookFilter[] $filters List of filters to apply to restrict calls to the Webhook.
     *
     * @return $this
     */
